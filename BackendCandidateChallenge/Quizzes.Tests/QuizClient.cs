...
using Quizzes.Domain.Abstractions;
...
public class QuizClient
{
    ...
    public async Task<Response<object>> PutQuestionAsync(int quizId, int questionId, QuestionUpdateModel question, CancellationToken cancellationToken)
    {
        var request =
            new HttpRequestMessage(HttpMethod.Put, new Uri(_quizServiceUri, $"/api/quizzes/{quizId}/questions/{questionId}"))
            {
